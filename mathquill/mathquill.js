...
(function() {
  var mostOps = ('arg deg det dim exp gcd hom inf ker lg lim ln log max min abs sign round diff integrate sup'
  ...
  var builtInTrigs = // why coth but not sech and csch, LaTeX?
    'sin cos tan asin acos atan arcsin arccos arctan sinh cosh tanh sec csc cot asec acsc acot coth'.split(' ');
